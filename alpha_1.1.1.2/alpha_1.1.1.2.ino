...
const uint32_t ACCELERATION = 6000; // was 6000
...
const int32_t DEADBAND_STEPS = 50;
...
void selectAndTrackTarget() {
  ...
  static int lastTargetIndex = -1; // Track which target we're following
  ...
  if (closestTarget != nullptr) {
    ...
    if (closestIndex != lastTargetIndex) {
      ...
      Serial.println("Target changed - Kalman filters reset");
    }
